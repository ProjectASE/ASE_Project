...
public class ShowNote extends AppCompatActivity {
    ...
    {
        Toast.makeText(ShowNote.this, "update", Toast.LENGTH_SHORT).show();
        ...
        fStore.collection("Notes").document(uid).collection("myNotes").document(id).set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Log.d("data " , "updated");
                startActivity(new Intent(ShowNote.this, NotesManagement.class));
    ...
    {
        Toast.makeText(ShowNote.this, "add", Toast.LENGTH_SHORT).show();
        ...
        Note newNote = new Note(eId, title, note);
        colref.document(eId).set(newNote).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(ShowNote.this, "Note Added.", Toast.LENGTH_LONG).show();
                startActivity(new Intent(ShowNote.this, NotesManagement.class));
...
//                startActivity(i);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ShowNote.this, "Error, Try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}