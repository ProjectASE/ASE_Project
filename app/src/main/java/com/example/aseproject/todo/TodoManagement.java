...
public class TodoManagement extends AppCompatActivity {

    Button add_notes;
    ListView listView;
    ArrayAdapter adapter;
    ArrayList<String> notesArray;
    ArrayList<Todo> allNotes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_notes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(TodoManagement.this, ShowTodo.class);
    ...
    public void signUserOut() {
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                Intent myIntent = new Intent(TodoManagement.this, MainActivity.class);
...
//                startActivity(i);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(TodoManagement.this, "Error, Try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void viewNotes() {
        FirebaseFirestore.getInstance()
                .collection("Todo").document(FirebaseAuth.getInstance().getCurrentUser().getUid().toString()).collection("myTodo")
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (int i=0; i<myListOfDocuments.size(); i++)
                            {
                                ...
                                String note = myListOfDocuments.get(i).getString("todo");

                                Todo myNote = new Todo(id, title, note);
                                allNotes.add(myNote);
...
//        Toast.makeText(Friends.this, "FE = " + items.size(), Toast.LENGTH_LONG).show();
    ...
    {
        AlertDialog.Builder adb=new AlertDialog.Builder(TodoManagement.this);
        ...
        adb.setPositiveButton("Accept", new AlertDialog.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                FirebaseFirestore.getInstance()
                        .collection("Todo").document(FirebaseAuth.getInstance().getCurrentUser().getUid().toString()).collection("myTodo").document(allNotes.get(position).getId()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
